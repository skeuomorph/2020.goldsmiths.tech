<template>
  <div id='event'>
    ...
    <EventIntroText :sidebar='introTextSidebarItems'>
      <h2>Build awesome games 0w0, with all the support you need.</h2>
      <p>A little party never killed nobody.</p>
      <p>So we gon' dance until we drop.</p>
  ...
  data() {
    return {
      ...
      hero: {
        ...
        desc: 'Game Jam Jim Pam Cam a Ram. Fun for the whole Family.',
        buttons: [
          { label: 'Highlights from 2019', path: '/no-website-yet' },
          { label: 'Get free tickets, if you wanna', path: '/free-tix' }
        ]
      },
