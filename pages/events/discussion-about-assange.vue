  ...
  <div id='event'>
    ...
    <EventIntroText :sidebar='introTextSidebarItems'>
      ...
      <p style="text-align:center;"><img src="/events/discussion-about-assange/assange-poster.jpg" width="425" height="600"></p>
        ...
        <p>One of our key values is "Information wants to be free. Everyone should have access to knowledge and skills. It should not be held back by individuals, governments or companies". When presented with the Assange case, we inherently empathised with the actions of Julian Assange, Chelsea Manning, and all whistleblowers in general. Their actions highlighted the hypocrisy that Western governments possess, which is that they are able to "intervene" (i.e destroy land and societies), in the Middle East especially, while not holding themselves to the same standards.</p>
        <p>Other questions surrounding the Julian Assange case have also been raised over the past decade, including the Swedish rape allegations, and collusion with the Republican party and Russia. These branches of information have caused a split in support for Julian Assange, Chelsea Manning, and Wikileaks. We hold this event not to deny anyone's experiences, but to bring together varied opinions, evidence, and to hopefully reach a consensus as a community.</p>
        <br>
        <h2>Programme</h2>
          17:15: Doors open
        <br>
