  ...
  data() {
    return {
      ...
      hero: {
        ...
        desc: 'Join us for two hours to discuss Julian Assange, and how his case has evolved over the past decade. Scepticism and contradictory proof are welcomed and encouraged.',
        buttons: [
